...
the whole system up and makes **62 checks against reality**:
...
| --- | --- | --- |
| **Docker** | `--target local`: broker, Postgres per service, MinIO, Jaeger, flagd, the edge and your services | `./demo.sh` brings the system up and makes 62 checks against reality |
...
| [The demo, measured](https://andrew-tellez.github.io/axon/demo.html) | The 62 checks against real containers, and what running it twice proves |
