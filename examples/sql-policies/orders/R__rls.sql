...
--   axon rls manifests/ --service orders > sql-policies/orders/R__rls.sql
--
...
-- orders.order: masked view. The read role is given this one and
...
-- orders.order_item: per-tenant isolation
ALTER TABLE "order_item" ENABLE ROW LEVEL SECURITY;
-- FORCE: the policy applies to the table's owner too, which is
-- who usually skips it without noticing.
ALTER TABLE "order_item" FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "order_item_tenant" ON "order_item";
